...
- `../skill-management_skill-create-rule/SKILL.md` is the single source of truth for skill-document structure, frontmatter, and companion-artifact requirements; consult it when deciding what the skill document itself must contain, not for history-record creation timing or content.
